...
- [x] Atomically bind same-instance epoch fencing to the pre-connect owner identity; allow released-row reclaim but reject another replica/process claim during upstream connect.
