...
- [x] Validate exact persisted `msg_` user bookkeeping and strip only its response-owned id/create-time fields from the proved one-shot projection; reject malformed lookalikes.
